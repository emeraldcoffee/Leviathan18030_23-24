...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(40, 1.5, 1.1);
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        // we should be able to not use an IMU since we're not using drive encoders
        ...
        setLocalizer(new NewStandardTrackingWheelLocalizer(hardwareMap, lastTrackingEncPositions, lastTrackingEncVels));
