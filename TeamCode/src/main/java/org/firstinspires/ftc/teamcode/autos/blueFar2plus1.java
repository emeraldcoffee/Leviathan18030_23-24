...
//        int cameraMonitorViewId = hardwareMap.appContext.getResources().getIdentifier("cameraMonitorViewId", "id", hardwareMap.appContext.getPackageName());
        ...
        TrajectorySequence right = driveTrain.trajectorySequenceBuilder(new Pose2d(-32, 64, Math.toRadians(270)))
        ...
        driveTrain.update();
        driveTrain.setPoseEstimate(new Pose2d(-32, 64, Math.toRadians(270)));
