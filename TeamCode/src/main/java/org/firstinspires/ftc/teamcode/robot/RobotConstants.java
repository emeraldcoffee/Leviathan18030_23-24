...
public class RobotConstants {
    ...
    intakeAdjustDelayTime = .2,
            ...
            stackOffset = .037,
            stackMax = .40 + stackOffset,
            stack5 = .239 + stackOffset,
            stack4 = .212 + stackOffset,
...
//        autoTransferTime = 4;
    ...
    public static final PIDCoefficients slidePIDVals = new PIDCoefficients(1.575 / 8192, 0 / 8192, .045 / 8192);
